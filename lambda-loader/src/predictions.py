...
class Predictions:
    ...
    def create_prediction(self, body="default"):
        ...
        if r.status_code == 200:
            return {
                "id": obj["data"][0]["id"],
                "outcome_ids": [
                    obj["data"][0]["outcomes"][0]["id"],
                    obj["data"][0]["outcomes"][1]["id"],
                ],
            }
        else:
            return -1
    ...
    def get_current_prediction(self):
        r = requests.get(
            f"{PREDICTIONS_URL}?broadcaster_id={self.broadcaster_id}",
...
# channel_id = os.environ['TWITCH_ID']

# p = Predictions('liihs', channel_id, client_id, access_token, 90)
