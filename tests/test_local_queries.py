...
class TestLocalLeaderboardQueries(unittest.TestCase):
    ...
    def test_peak(self):
        ...
        test_cases = [
            ...
            (
                "!peak dogdog",
                "Expected peak rating for dogdog in their most active server",
            ),
            # Invalid cases
    ...
    def test_day(self):
        ...
        test_cases = [
            ...
            (
                "!day dogdog",
                "Expected daily stats for dogdog in their most active server",
            ),
            # Error cases
    ...
    def test_week(self):
        ...
        test_cases = [
            ...
            (
                "!week dogdog",
                "Expected weekly stats for dogdog in their most active server",
            ),
            # Error cases
    ...
    def parse_command(self, command):
        ...
        if len(parts) >= 2 and parts[0] in VALID_SERVERS:
            ...
            len(parts) >= 2
            and parts[0] not in VALID_SERVERS
            and parts[1] not in VALID_SERVERS
        ):
            parts = [
                parts[0],
                "XX",
            ]  # Use XX as invalid server for consistent error message
...
if __name__ == "__main__":
    ...
    if test_result.wasSuccessful():
        ...
        print(
            "This is expected since we need to update the test cases with actual data"
        )
